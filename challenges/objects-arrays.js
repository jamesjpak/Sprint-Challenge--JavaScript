...
console.log(bigDinosaur.weight);

// What was the diet of a velociraptor?
console.log(smallDinosaur.diet);

// How long was a stegosaurus?
console.log(mediumDinosaur.length);

// What time period did tyrannosaurus live in?
console.log(bigDinosaur.period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(bigDinosaur.roar);
...
*/
let populationTotal = [];
  const animalTotal = zooAnimals.reduce(function(accumulator, currentValue) {
    populationTotal.push(currentValue.population)
